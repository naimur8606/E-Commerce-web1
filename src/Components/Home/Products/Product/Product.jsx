    ...
    return (
        <div className="border border-[#2c2cffc2] p-3 rounded-lg hover:shadow-lg truncate">
            ...
            <div className="flex justify-between gap-2">
                <button className="btn w-[48%] font-semibold bg-green-500 text-white hover:text-green-500">{btn}</button>
                <button className="btn w-[48%] font-semibold bg-blue-500 text-white hover:text-blue-500">Details</button>
            </div>
        </div>
    );
};
