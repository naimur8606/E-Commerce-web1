...
const UpdateProduct = () => {
    ...
    const updateProduct = e => {
        ...
        fetch(`https://sob-dokander-server.vercel.app/products/${_id}`, {
            method: "PUT",
            headers: {
    ...
    return (
        <div className="md:p-24 bg-[url('https://i.ibb.co/18M4yx4/sd-banner.png')] mx-auto bg-center bg-cover bg-blend-overlay bg-[#000] bg-opacity-10 py-8">
            ...
            <form onSubmit={updateProduct} className='w-11/12 md:w-full mx-auto'>
                <div className="md:flex md:md:mb-8">
                    <div className="form-control md:w-1/2">
                        <span className="label-text text-black text-lg">Product Name</span>
                        <input type="text" name="name"  placeholder="Product Name" defaultValue={name} className="input input-bordered w-full bg-white" required />
                    </div>
                ...
                <div className="md:mb-8">
                    ...
                    <textarea className='p-3 w-full rounded-lg'  placeholder='Enter Description' name="description" defaultValue={description} id="" cols="" rows="6"></textarea>
                </div>
